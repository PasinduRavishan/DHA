...
export default function EditProductPage() {
    ...
    useEffect(() => {
        Promise.all([fetchCategories(), fetchProduct()]).then(() => setLoading(false));
    }, []);
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <Link href={`/admin/products/${params.id}`} className="flex items-center gap-2 text-gray-500 mb-6 hover:text-gray-900">
            ...
            <form onSubmit={onSubmit} className="space-y-8 bg-white p-8 rounded-lg shadow border border-gray-100">
                ...
                <div className="flex justify-end gap-4 pt-4 border-t">
                    <button
                        type="submit"
                        disabled={loading}
                        className="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50"
                    >
