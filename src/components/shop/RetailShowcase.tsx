...
export default function RetailShowcase({ products, categories, carouselSlides }: RetailShowcaseProps) {
                            ...
                            <div className="mb-8">
                                ...
                                <p className="text-2xl font-light text-neutral-200">
                                    {selectedProduct.price && selectedProduct.price > 0
                                        ...
                                        : <span className="text-primary-500 font-bold text-lg">Price on Application</span>
                                    }
                                </p>
                            </div>
